...
copyright = "%s CC-BY-SA" % (datetime.date.today().year)
...
ogp_site_url = f"https://ubuntu.com/security/livepatch/docs/"
...
html_context = {
    ...
    "product_page": "ubuntu.com/security/livepatch",
    # Product tag image; the orange part of your logo, shown in the page header
    # TODO: To add a tag image, uncomment and update as needed.
    # 'product_tag': '_static/tag.png',
    # Your Discourse instance URL
    # TODO: Change to your Discourse instance URL or leave empty.
    "discourse": "https://discourse.ubuntu.com/c/project/livepatch/82",
    ...
    "github_url": "https://github.com/canonical/livepatch-docs",
...
html_baseurl = f"https://ubuntu.com/security/livepatch/docs/"
