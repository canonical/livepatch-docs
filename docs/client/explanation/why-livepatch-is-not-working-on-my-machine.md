...
A full list of supported kernels is available [here](/client/reference/supported-kernels.md).
...
As above, a full list of GA and HWE kernels supported is available [here](/client/reference/supported-kernels.md)
