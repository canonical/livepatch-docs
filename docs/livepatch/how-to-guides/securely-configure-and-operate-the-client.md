...
1. [How to configure the Livepatch client](/livepatch/how-to-guides/configure-livepatch-client.md)
2. [Livepatch client configuration options reference](/livepatch/reference/configuration-options.md)
