...
A full list of supported kernels is available [here](/livepatch/reference/supported-kernels.md).
...
As above, a full list of GA and HWE kernels supported is available [here](/livepatch/reference/supported-kernels.md)
