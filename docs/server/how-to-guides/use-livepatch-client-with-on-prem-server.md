...
The tier parameter is one of the tiers available on the server. The client will download patches as they become available in that tier. See [this page](/server/reference/patch-management.md) on how to manage tiers and patches in your on-prem server.
