...
For our reactive charm (or if your deployment config doesn't match the below), please see [here](/server/how-to-guides/migrate-from-reactive-charm-to-operator-charm.md).
```
...
- Basic auth can be a comma separated list, see [here](/server/how-to-guides/setup-administration-tool.md#password-authentication) for more info.
...
See our [how-to](/server/explanation/patch-storage/index.md) on patch storage.
