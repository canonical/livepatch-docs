...
- [Authentication reference](/server/reference/authentication.md): Technical details on all authentication and authorization mechanisms.
- [Harden your deployment](/server/how-to-guides/harden-your-deployment.md): How to securely configure the server for production deployments.
- [Configure logging and monitoring](/server/how-to-guides/configure-logging-and-monitoring.md): How to use the security event logging and Prometheus monitoring features.
- [Decommission the server securely](/server/how-to-guides/decommission.md): How to securely remove the server and its data.
- [Security lifecycle](/server/explanation/security-lifecycle.md): How security updates are delivered and applied.
- [Report vulnerabilities](/server/how-to-guides/report-vulnerabilities.md): How to report security vulnerabilities.
