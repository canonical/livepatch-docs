...
See this [how-to](/server/how-to-guides/use-livepatch-client-with-on-prem-server.md) to understand how to generate tokens.

For a technical reference of all authentication mechanisms (Basic Auth, Macaroons, resource tokens, sync tokens) and the cryptographic technologies they use, see [Authentication and authorization](/server/reference/authentication.md).
