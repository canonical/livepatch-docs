...
See our [patch-sync config](/livepatch_on_prem/reference/configuration.md) for more details.
...
If Livepatch on-prem has been deployed using Juju with our older reactive charm (see our migration guide [here](/livepatch_on_prem/how-to-guides/migrate-from-reactive-charm-to-operator-charm.md)), run the following Juju configuration command:
