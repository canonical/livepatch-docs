...
For more information on how to configure an HTTPS proxy on the Livepatch Client, please check out [this](/livepatch/how-to-guides/configure-proxy.md) guide.
